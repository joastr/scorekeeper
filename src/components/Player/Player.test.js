...
it('renders correct score', () => {
    ...
    const playerScoreRenderedText = playerComponent.find('.Player__score').text();
    const playerScoreRendered = Number(playerScoreRenderedText);
...
it('should call onPlayerRemove when x button is clicked', () => {
    ...
    const xButton = playerComponent.find('.Player__button_remove').at(0);
